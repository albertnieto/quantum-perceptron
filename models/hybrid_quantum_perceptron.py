# models/hybrid_quantum_perceptron.py

import pennylane as qml
from pennylane import numpy as np

def hybrid_quantum_perceptron(X_train, y_train):
    """
    Hybrid Quantum Perceptron that combines classical updates with quantum computations.
